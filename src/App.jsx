  ...
  return (
    <div style={{position:"fixed",inset:0,background:"rgba(4,4,4,0.97)",zIndex:200,overflowY:"auto",padding:"12px 10px"}}>
      ...
      <div style={{maxWidth:580,margin:"0 auto",background:G.card,border:`1px solid ${G.border}`,overflow:"hidden"}}>
        ...
        {/* ══ CHECK-IN ══ */}
        {phase==="checkin"&&<ReadinessGate onComplete={data=>{setReadiness(data);setPhase("session");}}/>}
        ...
        {(phase==="session"||(isDone&&phase!=="wins"&&phase!=="complete_acc"))&&cur&&(
          <div>
            ...
            {cur.type==="main"&&(
              <div style={{padding:"24px 16px"}}>
                <div style={{background:G.card2,border:`1px solid ${G.border}`,padding:"28px 20px",textAlign:"center",marginBottom:20}}>
                  ...
                  <div style={{fontFamily:F.display,fontSize:40,color:G.text,letterSpacing:3,lineHeight:1,marginBottom:12}}>
                    {cur.ex.name.toUpperCase()}
                  </div>
                  <div style={{fontFamily:F.display,fontSize:72,color:G.text,lineHeight:1,marginBottom:4}}>
                ...
                <div style={{display:"flex",gap:8,marginBottom:20}}>
                  <button onClick={()=>onTimer({proto:cur.ex.proto,exName:cur.ex.name})}
                    style={{flex:1,padding:"10px 0",background:G.card2,border:`1px solid ${G.border}`,
                      fontFamily:F.display,fontSize:13,letterSpacing:3,color:G.muted,cursor:"pointer"}}>
                    ▶ {cur.ex.proto} TIMER
                  </button>
                  {cur.row.w&&(
            ...
            {cur.type==="rpe"&&(
              <div style={{padding:"24px 16px"}}>
                ...
                <button onClick={()=>onTimer({proto:cur.ex.proto,exName:cur.ex.name})}
                  style={{width:"100%",padding:"10px 0",background:G.card2,border:`1px solid ${G.border}`,
                    fontFamily:F.display,fontSize:13,letterSpacing:3,color:G.muted,cursor:"pointer",marginBottom:16}}>
                  ▶ {cur.ex.proto} TIMER
                </button>
