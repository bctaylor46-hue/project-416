...
const FC    = {"Upper Body":G.gold,"Lower Body":G.gold,"Full Body":G.goldDim||G.teal};
      ...
      {f.opts.map(o => { const sel = mev[f.key]===o.v; return (
        <button key={o.l} onClick={()=>tog(f.key,o.v)}
          style={{padding:"5px 11px",borderRadius:4,border:sel?`1px solid ${G.gold}`:`1px solid ${G.border}`,
            background:sel?"#1a0a28":"#0a0a0a",color:sel?G.gold:G.muted,fontSize:11,cursor:"pointer",fontWeight:sel?700:400}}>
    ...
    <div>
      <div style={{background:G.card,borderRadius:10,padding:"12px 16px",border:`1px solid ${G.border}`,display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14}}>
        <div>
          ...
          <div style={{fontSize:26,fontWeight:900,color:volScore>0?G.teal:volScore<0?G.red:G.gold}}>{volScore>0?"+":""}{volScore}</div>
        </div>
...
const ProtoTag = ({proto,exName,onTimer}) => (
  <div style={{display:"flex",gap:5,alignItems:"center"}}>
    <span style={{fontFamily:F.display,fontSize:12,background:"#1a0a28",color:G.gold,padding:"1px 8px",letterSpacing:2}}>{proto}</span>
...
const ProtoTagAcc = ({proto,exName,onTimer}) => (
  <div style={{display:"flex",gap:5,alignItems:"center",flexShrink:0}}>
    {proto&&<span style={{fontSize:10,color:G.gold,background:"#1a0a28",borderRadius:3,padding:"2px 7px",fontWeight:700,letterSpacing:1}}>{proto}</span>}
  ...
  return (
    <div style={{padding:"20px 16px"}}>
      ...
      {READINESS_Qs.map(q=>{
        ...
        const c = q.inverted
          ? (val<=4?G.gold:val<=7?G.goldLt||G.gold:G.muted)
          : (val>=7?G.gold:val>=4?G.goldLt||G.gold:G.goldDim||G.teal);
        return (
...
const qColor = v => v>=8?G.gold:v>=6?G.goldLt||G.gold:v>=4?G.goldDim||G.teal:G.muted;
  ...
  return (
    <div style={{padding:"28px 16px",textAlign:"center"}}>
      ...
      <div style={{marginBottom:20}}>
        ...
        <div id="session-share-card" style={{
          ...
          <div style={{display:"flex",gap:16,marginBottom:16,paddingBottom:12,borderBottom:`1px solid ${G.border}`}}>
            <div style={{flex:1}}>
              ...
              <div style={{fontFamily:F.display,fontSize:11,color:G.gold,letterSpacing:2,marginTop:3}}>{readiness.profile.icon} {readiness.profile.label}</div>
            </div>
            <div style={{flex:2}}>
              <div style={{fontFamily:F.display,fontSize:9,color:G.muted,letterSpacing:3,marginBottom:6}}>PROGRAM</div>
              <div style={{fontFamily:F.display,fontSize:22,color:G.gold,letterSpacing:2,lineHeight:1,marginBottom:6}}>{completed.size}<span style={{fontSize:12,color:G.muted}}>/16 SESSIONS</span></div>
            ...
            if (ex.type==="main") {
                ...
                <div key={i} style={{marginBottom:14,paddingBottom:14,borderBottom:`1px solid ${G.border}`}}>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:8}}>
                    <div>
                      ...
                      <div style={{fontFamily:F.display,fontSize:18,color:G.gold,letterSpacing:2,lineHeight:1}}>{ex.name.toUpperCase()}</div>
                    </div>
                  ...
                  <div style={{display:"flex",gap:4,flexWrap:"wrap"}}>
                    {["i","ii","iii","iv","v"].map((ro,ri)=>(
                      <div key={ro} style={{background:"#0a0a0a",border:`1px solid ${ri===2?G.gold:G.border}`,padding:"4px 8px",textAlign:"center",minWidth:44}}>
                        <div style={{fontFamily:F.display,fontSize:8,color:ri===2?G.gold:G.muted,letterSpacing:1}}>{ro}</div>
                        <div style={{fontFamily:F.display,fontSize:13,color:ri===2?G.gold:G.text,letterSpacing:1}}>{ex.pat?.reps[ri]}</div>
                      </div>
                    ))}
                    <div style={{background:"#181020",border:`1px solid ${G.gold}40`,padding:"4px 8px",textAlign:"center",alignSelf:"center"}}>
                      <div style={{fontFamily:F.display,fontSize:8,color:G.goldDim||G.teal,letterSpacing:1}}>TARGET</div>
                      <div style={{fontFamily:F.display,fontSize:13,color:G.gold,letterSpacing:1}}>{ex.pat?.tl}{readiness.adj?` ${readiness.adj}%ADJ`:""}</div>
                    </div>
                  </div>
                </div>
              );
                ...
                <div key={i} style={{marginBottom:14,paddingBottom:14,borderBottom:`1px solid ${G.border}`}}>
                  ...
                  {[ex.exA, ex.exB].map((e,j)=>(
                    <div key={j} style={{marginBottom:6}}>
                      <div style={{fontFamily:F.display,fontSize:15,color:G.gold,letterSpacing:2,marginBottom:3}}>{e.name.toUpperCase()}</div>
                      <div style={{display:"flex",gap:4,flexWrap:"wrap"}}>
                        {e.sets.map((set,si)=>(
              ...
              return (
                <div key={i} style={{marginBottom:14,paddingBottom:14,borderBottom:`1px solid ${G.border}`}}>
                  ...
                  <div style={{fontFamily:F.display,fontSize:15,color:G.gold,letterSpacing:2,marginBottom:6}}>{ex.name.toUpperCase()}</div>
                  <div style={{display:"flex",gap:4,flexWrap:"wrap"}}>
                    {ex.sets.map((set,si)=>(
                      <div key={si} style={{background:"#0a0a0a",border:`1px solid ${G.border}`,padding:"3px 8px",textAlign:"center"}}>
                        <div style={{fontFamily:F.display,fontSize:8,color:G.muted,letterSpacing:1}}>SET {si+1}</div>
        ...
        {/* Screenshot hint */}.border}`,padding:"3px 8px",textAlign:"center"}}>
                        <div style={{fontFamily:F.display,fontSize:8,color:G.muted,letterSpacing:1}}>SET {si+1}</div>
                        <div style={{fontFamily:F.display,fontSize:12,color:G.text,letterSpacing:1}}>{set.n>1?`${set.n}×`:""}{set.reps}{set.rpe?` @${set.rpe}`:""}</div>
                      </div>
                    ))}
      ...
      <div style={{maxWidth:580,margin:"0 auto",background:G.card,border:`1px solid ${G.border}`,overflow:"hidden"}}>
        ...
        <div style={{background:G.card2,padding:"14px 16px",borderBottom:`1px solid ${G.border}`,display:"flex",justifyContent:"space-between",alignItems:"center"}}>
          <div style={{display:"flex",gap:8,alignItems:"center",flexWrap:"wrap"}}>
            ...
            <span style={{fontFamily:F.display,fontSize:12,color:G.gold,letterSpacing:2,background:`${G.gold}15`,padding:"1px 10px",border:`1px solid ${G.teal}50`}}>{s.focus.toUpperCase()}</span>
        ...
        {isPR&&phase==="session"&&<div style={{background:"#0d000d",padding:"9px 16px",borderBottom:`1px solid ${G.gold}30`}}>
                  ...
                  <div>
                    ...
                    <div style={{display:"flex",gap:5,marginTop:8,flexWrap:"wrap"}}>
                      {flatEx(nextSession.exercises).map((e,i)=>(
                        <span key={i} style={{fontSize:10,color:e.type==="main"?G.gold:G.gold,background:e.type==="main"?"#1a1000":"#0a1020",borderRadius:3,padding:"2px 7px"}}>{e.name}</span>
                      ))}
                    </div>
                  </div>
                    ...
                    <div style={{display:"flex",justifyContent:"space-between",gap:10,alignItems:"flex-start"}}>
                      <div style={{flex:1,minWidth:0}}>
                        ...
                        {mainEx.length>0&&<div style={{marginBottom:8}}>
                          <div style={{fontSize:8,color:G.goldDim||G.teal,letterSpacing:2,fontWeight:700,marginBottom:5}}>MAIN LIFTS</div>
                          <div style={{display:"flex",flexWrap:"wrap",gap:5}}>
                            {mainEx.map((e,i)=><span key={i} style={{fontSize:11,color:G.gold,background:"#1a0a28",borderRadius:3,padding:"2px 8px"}}>{e.name}</span>)}
                          </div>
                        </div>}
                        {accEx.length>0&&<div>
          ...
          <div>
            ...
            <div style={{...cardStyle,padding:16}}>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14}}>
                ...
                <div style={{fontSize:12,fontWeight:800,color:volScore>0?G.teal:volScore<0?G.red:G.gold}}>{volScore>0?"+":""}{volScore}</div>
              </div>
