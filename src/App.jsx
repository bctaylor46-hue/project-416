...
// ── Google Fonts ───────────────────────────────────────────────────────────────
const FONTS = "@import url('https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Montserrat:wght@300;400;600;700;800;900&family=Protest+Riot&display=swap');";
...
const F = { display:"'Bebas Neue', sans-serif", body:"'Montserrat', sans-serif", riot:"'Protest Riot', sans-serif" };
...
const Logo = ({size="lg"}) => {
  ...
  return (
    <div style={{textAlign:"center",fontFamily:F.body}}>
      ...
      <div style={{fontFamily:F.riot,fontSize:big?72:26,background:goldGrad,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",backgroundClip:"text",lineHeight:1,letterSpacing:big?3:1}}>
        4:16
      </div>
...
function WinsScreen({readiness,sessionId,completed,qualityRatings,onClose}) {
  ...
  return (
    <div style={{padding:"28px 16px",textAlign:"center"}}>
      ...
      <div style={{fontFamily:F.riot,fontSize:48,color:G.text,letterSpacing:0,lineHeight:1,marginBottom:6}}>YOU SHOWED UP.</div>
    ...
    <div style={{position:"fixed",inset:0,background:"rgba(4,4,4,0.97)",zIndex:200,overflowY:"auto",padding:"12px 10px"}}>
      ...
      <div style={{maxWidth:580,margin:"0 auto",background:G.card,border:`1px solid ${G.border}`,overflow:"hidden"}}>
        ...
        {isPR&&phase!=="overview"&&<div style={{background:G.card2,padding:"9px 16px",borderBottom:`1px solid ${G.border}`}}>
          <span style={{fontFamily:F.riot,fontSize:16,color:G.text,letterSpacing:0}}>🏆 PR WEEK — LEAVE EVERYTHING IN THE TANK</span>
        </div>}
                ...
                {mainEx.map((ex,i)=>{
                  ...
                  return (
                    <div key={i} style={{borderBottom:`1px solid ${G.border}`,paddingBottom:14,marginBottom:14}}>
                      <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:8}}>
                        <div>
                          <div style={{fontFamily:F.riot,fontSize:24,color:G.text,letterSpacing:0,lineHeight:1,marginBottom:4}}>{ex.name.toUpperCase()}</div>
            ...
            {isDone?(
              ...
              <button onClick={()=>setPhase("checkin")}
                style={{width:"100%",padding:18,background:goldGrad,border:"none",
                  fontFamily:F.riot,fontSize:28,letterSpacing:0,color:G.text,cursor:"pointer"}}>
                START SESSION →
              </button>
            )}
          </div>
            ...
            {cur.type==="main"&&(
              <div style={{padding:"24px 16px"}}>
                <div style={{background:G.card2,border:`1px solid ${G.border}`,padding:"28px 20px",textAlign:"center",marginBottom:20}}>
                  ...
                  <div style={{fontFamily:F.riot,fontSize:40,color:G.text,letterSpacing:0,lineHeight:1.1,marginBottom:12}}>
            ...
            {cur.type==="rpe"&&(
              <div style={{padding:"24px 16px"}}>
                ...
                <div style={{textAlign:"center",marginBottom:20}}>
                  ...
                  <div style={{fontFamily:F.riot,fontSize:36,color:G.text,letterSpacing:0,lineHeight:1.1,marginBottom:8}}>
                    {cur.ex.name.toUpperCase()}
                  </div>
        ...
        {phase==="complete_acc"&&(
          <div style={{padding:"28px 16px",textAlign:"center"}}>
            ...
            <div style={{fontFamily:F.riot,fontSize:40,color:G.text,letterSpacing:0,lineHeight:1,marginBottom:24}}>SESSION COMPLETE</div>
    ...
    <div>
      ...
      {loading2 && (
        <div style={cs}>
          ...
          {loading2&&loading2.every(c=>c===0)&&<div style={{padding:16,fontSize:12,color:G.muted,textAlign:"center",fontFamily:F.body}}>Bar only — {BAR_ACTIVE} {isKg?"kg":"lbs"}</div>}
        </div>
      )}
  ...
  if (loading) return (
    <div style={{minHeight:"100vh",background:G.black,display:"flex",alignItems:"center",justifyContent:"center"}}>
      <div style={{textAlign:"center"}}>
        <div style={{fontFamily:F.display,fontSize:48,background:goldGrad,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",backgroundClip:"text",letterSpacing:3}}>4:16</div>
