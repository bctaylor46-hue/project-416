              ...
              return (
                <div key={i} style={{marginBottom:14,paddingBottom:14,borderBottom:`1px solid ${G.border}`}}>
                  ...
                  <div style={{display:"flex",gap:4,flexWrap:"wrap"}}>
                    ...
                    <div style={{background:"#0d0b00",border:`1px solid ${G.gold}40`,padding:"4px 8px",textAlign:"center",alignSelf:"center"}}>
                      <div style={{fontFamily:F.display,fontSize:8,color:G.goldDim,letterSpacing:1}}>TARGET</div>
...
function BarLoaderSheet({seedLbs, onClose}) {
  ...
  const BAR_LB = 45;
  const PLATES_LB = [
    {lb:45, label:"45",  name:"Blue",   color:"#1a4fc4", textColor:"#fff"},
    {lb:35, label:"35",  name:"Yellow", color:"#d4a800", textColor:"#111"},
    {lb:25, label:"25",  name:"Red",    color:"#CC2200", textColor:"#fff"},
    {lb:10, label:"10",  name:"White",  color:"#d8d8d8", textColor:"#111"},
    {lb:5,  label:"5",   name:"Blue",   color:"#2255aa", textColor:"#fff"},
  ...
  const PlateRow = ({counts,side}) => {
    ...
    // Left side: sleeve → lightest → heaviest → collar → bar
    //   array must be lightest-first so heaviest renders last (nearest collar)
    if(side==="left") plates = [...plates].reverse();
    // Right side: bar → collar → heaviest → lightest → sleeve
    //   array stays heaviest-first so heaviest renders first (nearest collar)
    return (
...
const PLATES_DATA = [
  ...
  { kg:10,   label:"10",   name:"Green",  color:"#1e6b2e", textColor:"#fff" },
