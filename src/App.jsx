    ...
    <div style={{position:"fixed",inset:0,background:"rgba(4,4,4,0.97)",zIndex:200,overflowY:"auto",padding:"12px 10px"}}>
      ...
      <div style={{maxWidth:580,margin:"0 auto",background:G.card,border:`1px solid ${G.border}`,overflow:"hidden"}}>
        ...
        {!isDone&&<div style={{display:"flex",gap:2,height:3}}>
          {PHASES.map((p,i)=>(
            <div key={p} style={{flex:1,background:phase===p?goldGrad:PHASES.indexOf(phase)>i?"#444":G.border}}/>
          ))}
        </div>}

        {isPR&&phase==="session"&&<div style={{background:"#0a0a0a",padding:"9px 16px",borderBottom:`1px solid ${G.border}`}}>
            ...
            {cur.type==="main"&&(
              <div style={{padding:"24px 16px"}}>
                ...
                <div style={{textAlign:"center",marginBottom:20}}>
                  ...
                  <div style={{fontFamily:F.display,fontSize:40,color:G.text,letterSpacing:3,lineHeight:1,marginBottom:6}}>
                ...
                <div style={{marginBottom:20}}>
                  ...
                  <div style={{display:"flex",alignItems:"center",background:"#0a0a0a",border:`1px solid ${G.border}`,borderRadius:0}}>
                ...
                <div style={{display:"flex",gap:6,justifyContent:"center",marginBottom:20}}>
                  {["i","ii","iii","iv","v"].map((ro,i)=>(
                    <div key={ro} style={{width:36,height:36,display:"flex",alignItems:"center",justifyContent:"center",
                      ...
                      background:i<stepIdx-steps.findIndex(st=>st.ex.name===cur.ex.name&&st.type==="main")?goldGrad:i===stepIdx-steps.findIndex(st=>st.ex.name===cur.ex.name&&st.type==="main")?"#222":G.card2,
                      border:`1px solid ${i===stepIdx-steps.findIndex(st=>st.ex.name===cur.ex.name&&st.type==="main")?"#555":G.border}`,
                      color:i<stepIdx-steps.findIndex(st=>st.ex.name===cur.ex.name&&st.type==="main")?G.black:i===stepIdx-steps.findIndex(st=>st.ex.name===cur.ex.name&&st.type==="main")?G.text:G.muted}}>
                      {ro}
                    </div>
                  ))}
                </div>
            ...
            {cur.type==="rpe"&&(
              <div style={{padding:"24px 16px"}}>
                ...
                <div style={{textAlign:"center",marginBottom:20}}>
                  ...
                  <div style={{fontFamily:F.display,fontSize:40,color:G.text,letterSpacing:3,lineHeight:1,marginBottom:8}}>
                    {cur.ex.name.toUpperCase()}
                  </div>
        ...
        {phase==="complete_acc"&&(
          <div style={{padding:"28px 16px",textAlign:"center"}}>
            ...
            <div style={{fontFamily:F.display,fontSize:40,color:G.text,letterSpacing:3,lineHeight:1,marginBottom:16}}>SESSION COMPLETE</div>
